...
// import 'package:moneymattersmobile/providers/userList.dart';
                          ...
                          RegisterSignInButton(
                            ...
                            () {
                              if (form.currentState!.validate()) {
                                ...
                                int usernameIndex = userList.map((e) => e.username).toList().indexOf(widget.username!);
                                if (usernameIndex != -1) {
                                  User user = userList[usernameIndex];
                                  if (user.password == widget.password) {
                                    currUser = user;
                                    Navigator.push(
                                      context,
                                      PageTransition(
